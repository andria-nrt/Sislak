...
<form action="<?php echo e(route('Accounts.receive_voucher.store')); ?>" method="post">
    <?php echo csrf_field(); ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <input type="text" class="form-control" id="trans_date" name="trans_date" placeholder="Receive Date" required="" value="<?php echo e($tran_date); ?>">
                    </div>
                </div>
                <div class="form-group row">
...
</script><?php /**PATH C:\xampp\htdocs\sislak\resources\views/accounts/receiveVoucher/create.blade.php ENDPATH**/ ?>