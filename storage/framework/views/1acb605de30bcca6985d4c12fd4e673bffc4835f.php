...
<?php $__env->startSection('title', 'Kontra Voucher - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.''); ?>
...
<?php echo e($voucher->transaction_amount); ?>       
  ...
  <?php $__env->startSection('js'); ?>
    ...
    $(document).ready(function() {
        dataTableLoad({
            curUrl: "<?php echo e(route('Accounts.contra_voucher.index')); ?>",
            addUrl: "<?php echo e(route('Accounts.contra_voucher.create')); ?>"
        });
    });
    </script>
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/husnimubarok/Sites/localhost/caexpert/resources/views/accounts/contraVoucher/index.blade.php ENDPATH**/ ?>