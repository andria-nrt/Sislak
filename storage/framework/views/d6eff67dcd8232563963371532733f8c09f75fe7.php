<form action="<?php echo e(route('Accounts.general_ledger.store')); ?>" method="post">
    <?php echo csrf_field(); ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" id="type_id" name="type_id" required="">
                        ...
                        <option value="<?php echo e($accType->id); ?>"><?php echo e($accType->type_name); ?></option>
...
</script><?php /**PATH /Users/husnimubarok/Sites/localhost/caexpert/resources/views/accounts/generalLedger/create.blade.php ENDPATH**/ ?>