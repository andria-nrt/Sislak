...
<?php $__env->startSection('title', 'Journal Voucher - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.''); ?>
...
<?php if($set_currency->currency_position==2): ?><?php echo e($set_currency->symbol); ?><?php endif; ?> 
  ...
  <?php $__env->startSection('js'); ?>
    ...
    $(document).ready(function() {
        dataTableLoad({
            curUrl: "<?php echo e(route('Accounts.journal_voucher.index')); ?>",
            addUrl: "<?php echo e(route('Accounts.journal_voucher.create')); ?>"
        });
    });
    </script>
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/husnimubarok/Sites/localhost/caexpert/resources/views/accounts/journalVoucher/index.blade.php ENDPATH**/ ?>