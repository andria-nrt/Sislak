...
<form action="<?php echo e(route('Accounts.contra_voucher.update', $voucher->id)); ?>" method="put">
    <?php echo csrf_field(); ?>
...
</script><?php /**PATH /Users/husnimubarok/Sites/localhost/caexpert/resources/views/accounts/contraVoucher/edit.blade.php ENDPATH**/ ?>