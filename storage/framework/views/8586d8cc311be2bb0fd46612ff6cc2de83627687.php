   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="<?php echo e(url('accounts/migration')); ?>"><i class="fa fa-share"></i> Migrasi Akun  </a>
          </li>
        </ul>
      </li>
      ...
      <li>
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="<?php echo e(url('accounts/cash_book')); ?>"><i class="fa fa-window-restore"></i> Buku Kas </a>
          </li>
          <li>
            <a href="<?php echo e(url('accounts/bank_book')); ?>"><i class="fa fa-window-restore"></i> Buku Bank </a>
          </li>
        </ul>
      </li>
      <?php endif; ?>
...
<!-- End sidebar-wrapper
<?php /**PATH /Users/husnimubarok/Sites/localhost/caexpert/resources/views/expert/sidebar.blade.php ENDPATH**/ ?>