...
<form action="<?php echo e(route('Accounts.contra_voucher.store')); ?>" method="post">
    <?php echo csrf_field(); ?>
    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group row">
                    <label class="col-md-4 col-sm-12 control-label" for="total_amount">Total</label>
                    <div class="col-md-8 col-sm-12">
                        <input readonly="" type="text" class="form-control" id="total_amount" name="total_amount" placeholder="Total">
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group row">
                    <label class="col-md-4 col-sm-12 control-label required" for="cr_sl_id">Buku Besar Kredit</label>
                    <div class="col-md-8 col-sm-12">
...
</script><?php /**PATH /Users/husnimubarok/Sites/localhost/caexpert/resources/views/accounts/contraVoucher/create.blade.php ENDPATH**/ ?>