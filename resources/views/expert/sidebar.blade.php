   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        ...
        <ul class="sidebar-submenu">
          <li>
            <a href="{{url('accounts/chart_of_accounts')}}"><i class="fa fa-th-list"></i> Bagan Akun  </a>
          </li>
          <li>
            <a href="{{url('accounts/account_types')}}"><i class="fa fa-arrows-h"></i> Jenis Akun  </a>
          </li>
          <li>
            <a href="{{url('accounts/general_ledger')}}"><i class="fa fa-file"></i> Buku Besar  </a>
          </li>
          <li>
            <a href="{{url('accounts/subsidiary_ledger')}}"><i class="fa fa-file-o"></i> Buku Besar Pembantu  </a>
          </li>
        </ul>
      </li>
      ...
      <li>
        ...
        <ul class="sidebar-submenu">
          <li>
            <a href="{{url('accounts/payment_voucher')}}"><i class="fa fa-book"></i> Voucher Pembayaran  </a>
          </li>
          <li>
      ...
      <li>
        ...
        <ul class="sidebar-submenu">
          <li>
            <a href="{{url('accounts/balance_sheet')}}"><i class="fa fa-window-restore"></i> Neraca </a>
          </li>
          <li>
            <a href="{{url('accounts/income_statement')}}"><i class="fa fa-window-restore"></i> Laporan Laba Rugi </a>
          </li>
          <li>
            <a href="{{url('accounts/receipts_payments')}}"><i class="fa fa-window-restore"></i> Penerimaan &amp; Pembayaran </a>
          </li>
          <li>
            <a href="{{url('accounts/trial_balance')}}"><i class="fa fa-window-restore"></i> Neraca saldo </a>
          </li>
          <li>
            <a href="{{url('accounts/ledger_report')}}"><i class="fa fa-window-restore"></i> Laporan Buku Besar </a>
          </li>
        </ul>
      </li>
      @endif
