        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input readonly="" type="text" class="form-control" id="ledger_code" name="ledger_code" placeholder="Kode Buku Besar" value="{{$generalLedger->ledger_code}}">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input required="" type="text" class="form-control" id="ledger_head" name="ledger_head" placeholder="Masukan Nama Buku Besar" value="{{$generalLedger->ledger_head}}">
                </div>
            </div>           
